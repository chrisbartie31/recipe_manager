...
namespace recipePOE_Part2
{
    public class Recipe
    {
        ...
        public Recipe(string name, int numIngredients, int numSteps, string foodGroup, int calories)
        {
            Name = name;
        ...
        public bool IsPartOfFoodGroup(string selectedFoodGroup)
        {
            return string.IsNullOrEmpty(selectedFoodGroup) || FoodGroup == selectedFoodGroup;
        }
        ...
        public void CalsMaxCheck()
        {
            ...
            //Bill Wagner
            //https://github.com/BillWagner
            int totalCals = GettingTotalCals();
            if (totalCals > 300)
            {
                maxCals?.Invoke(totalCals); 
            }
           }
        }
    }
